...
import 'package:pedal/features/crew/widgets/crew_stats_summary_card.dart';
import 'package:pedal/features/crew/widgets/crew_card.dart';
      ...
      slivers: [
        ...
        SliverToBoxAdapter(
          child: Padding(
            ...
            child: Text('$userName님의 크루 추천', style: AppTextStyles.titMdMedium),
          ),
        ),
        SliverPadding(
        ...
        SliverToBoxAdapter(child: SizedBox(height: AppSpacing.x2l)),
      ],
    );
  }
}
